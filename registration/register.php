...
<div class="container">
	...
	<h4><strong><span style="font-size:17pt;text-align:justify;color:#008080;">Important Deadlines<br /></span></strong></h4>
		<ul style = "list-style-type:none;">
			<li>Early bird Registration closes on the <strike> 15th November, 2018 </strike> 30th November, 2018</li>
			<li>&nbsp&nbsp&nbsp(Due to technical difficulties the last date for early bird registration is extended up to 30th November.)</li>
			<li>Normal Registration from 1st December 2018 to 15th January, 2019</li>
		...
		<strong>We follow the Baker Island Time (BIT) i.e. UTC-12:00 for deciding date and time.</strong>
		<br>
	<br>
...
for the conference. </p>
	...
	<h4><strong><span style="font-size:17pt;text-align:justify;color:#008080;">Registration Fee<br /></span></strong></h4>
		...
		<p><strong>Financial Support:</strong> In addition to the differentiated fee, we hope to be able to find some money by way of donation to support a few authors who do not have adequate support. You could apply for this and depending on the availability of funds we will try and provide you partial support.</p><br><p>Please click on the following link to find more information on financial support and the application form. If you are eligible to apply for support, please fill in the application form and email it to both David Kollosche (<a href = "mailto:david.kollosche@ph-vorarlberg.ac.at">david.kollosche@ph-vorarlberg.ac.at</a>) and Yasmine Abtahi (<a href = "mailto:Yasmine.Abtahi@uottawa.ca">Yasmine.Abtahi@uottawa.ca</a>) before November 30th, 2018.</p><br>
        <a href = "media/Financial_Support.pdf" target = "_blank"><span style = "font-size:12pt;text-align:justify;color:#3366BB;">Click here to find more information on financial support and the application form.</span></a><br><br>
        <p><span style = "font-size:12pt;text-align:justify;color:#3366BB"><a href = "media/Financial_Support.pdf" download>Click here to Download the Financial Support document as pdf</a></span></p><br>
		...
		<p>We follow Baker Island Time (BIT) i.e. UTC-12:00.</p>
...
<li>No refund after 31st December, 2018.</li>
		...
		<br><br><br>
        <i style="float:right;color:grey;">Last Updated :30th November</i>
